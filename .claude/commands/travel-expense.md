...
| File | Contents |
|------|----------|
| `Travel.xlsx` | Master tracker — all trips, one tab per trip |
| `eStmt_YYYY-MM-DD.pdf` | Bank of America statement (typical naming) |
| `Document.pdf` | Wells Fargo statement (typical naming) |
| `Chase_Statement_*.pdf` | Chase statement (typical naming) |
